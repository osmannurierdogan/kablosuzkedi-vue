    ...
    div.flex.items-center.justify-center.mt-2.gap-x-1
      ...
      div.relative.group
        button.flex-shrink-0.w-10.h-10.p-2.flex.rounded-md.group.justify-center.items-center(class='!-z-[1] hover:bg-gray-200 group-focus-within:bg-gray-300')
          ...
          p.absolute.w-60.h-40.right-0.top-full.overflow-y-scroll.bg-white.invisible.rounded-md.shadow-lg.p-3.text-left.border-gray-300(class='!z-10 group-focus-within:visible group-hover:visible border-[1px]') {{ this.bookmarkItem.description }}
